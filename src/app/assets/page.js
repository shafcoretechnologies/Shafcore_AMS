...
export default async function AssetsPage() {
  ...
  const [branches, locations, bays, employees, assetTypes, assetModels, assets] = await Promise.all([
    ...
    <div className={styles.page}>
      <main className={styles.main}>
        <header className={styles.header}>
          ...
          <p>Submit assets with employee or bay assignment. New assets go to manager approval automatically.</p>
        </header>
        <AssetWorkspace
